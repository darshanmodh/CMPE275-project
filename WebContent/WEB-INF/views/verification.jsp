...
<body>
	...
	<div class="container">
			<form class="form-signin" method="post" action="/cmpe275/user/verification">
					<input id="inputEmail" name="inputEmail" class="form-control"
						type="email" placeholder="Email address" maxlength="50" required
						autofocus /> 
						<input id="inputVerificationCode" name="inputVerificationCode"
						class="form-control" type="text" placeholder="Code"
